...
// let thirdSectionCategories = ref([]);

// watch(secondSectionCategories, (newValue) => {
//   console.log(newValue);
//   thirdSectionCategories.value = mainCategories.value.slice(
//     firstSectionCategories.value.length + newValue.length,
//   );
// });
